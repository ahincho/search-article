...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{github-search-article.png}
\caption{Repositorio \texttt{search-article}: artículo LaTeX con pipeline CI/CD que compila automáticamente el PDF y genera releases versionados.}
\label{fig:github_article}
\end{figure}
