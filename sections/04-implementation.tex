...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{pypi-search-library.png}
\caption{Librería \texttt{search-library} publicada en PyPI (v1.0.0). Disponible para instalación directa con \texttt{pip install search-library}.}
\label{fig:pypi}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{github-search-library.png}
\caption{Repositorio principal \texttt{search-library} en GitHub: código fuente, tests, CI/CD y documentación del framework de algoritmos de búsqueda.}
\label{fig:github_core}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{github-graph-search.png}
\caption{Repositorio \texttt{graph-search}: benchmark de algoritmos de búsqueda sobre la red vial del sur de Perú (10 ciudades, 13 aristas ponderadas).}
\label{fig:github_graph}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.95\textwidth]{github-path-search.png}
\caption{Repositorio \texttt{path-search}: benchmark de algoritmos en grids 2D con 8 escenarios configurables (obstáculos, terrenos ponderados, bug trap, escalabilidad).}
\label{fig:github_path}
\end{figure}
